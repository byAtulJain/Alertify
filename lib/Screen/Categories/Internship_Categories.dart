...
class Internship_Categories extends StatefulWidget {
  @override
  State<Internship_Categories> createState() => _Internship_CategoriesState();
}

class _Internship_CategoriesState extends State<Internship_Categories> {
